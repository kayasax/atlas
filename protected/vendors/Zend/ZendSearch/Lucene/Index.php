...
require_once 'Zend\ZendSearch\Lucene\SearchIndexInterface.php';
require_once 'Zend\ZendSearch\Lucene\Storage\Directory\Filesystem.php';
require_once 'Zend\ZendSearch\Lucene\LockManager.php';
/**
 * @category   Zend
