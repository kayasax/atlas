...
<div class='well'>
    ...
    <p>Atlas est une application web développée en PHP conçue pour répondre au besoin d'indexation et de réorganisation des documents du service informatique SMAC. <br/>
        Elle devrait donc petit à petit remplacer le dossier partagé FICHES
    <br/>
    </p>
    <p>
    ...
    <ul class='unstyled'>
        ...
        <li><strong>Un moteur de recherche performant</strong> actuellement le moteur n'indexe pas le contenu des fichiers, et il souffre de problème avec les caractères accentués</li>
